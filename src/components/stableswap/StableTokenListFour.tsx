    ...
    <div className="mt-4 px-8">
      ...
      <div className="my-4">
        <div className="flex justify-end items-center text-xs text-right mb-1 text-farmText">
          ...
          :&nbsp;
          <span
            title={toReadableNumber(tokens[3].decimals, balances[tokens[3].id])}
          >
            {isSignedIn
              ? toPrecision(
        ...
        <div className="flex items-center">
          <div className="flex items-center w-28 xs:w-24 md:w-24 xs:flex-shrink-0 md:xs:flex-shrink-0">
            <Icon
              ...
              className="h-9 w-9 xs:h-7 md:h-7 xs:w-7 md:w-7 mr-2"
            />
            <div className="text-white text-base" title={tokens[3].id}>
              {toRealSymbol(tokens[3].symbol)}
            </div>
          </div>
          <InputAmount
            className="flex-grow border border-transparent rounded"
            max={toReadableNumber(tokens[3].decimals, balances[tokens[3].id])}
            onChangeAmount={changeFourTokenAmount}
            value={fourTokenAmount}
          />
        </div>
      </div>
    </div>
