...
export default function TipsBox(props: any) {
  ...
  return tipShow ? (
    <div
      {...props}
      className="flex relative items-center py-3 border border-framBorder rounded-lg mb-6 pl-6 pr-10 bg-cardBg xs:flex-col md:flex-col xs:mb-2.5 md:mb-2.5 xs:pr-6 md:pr-6"
    >
      <div
      ...
      <div className="text-sm text-white">
        <FormattedMessage id="stake_unstake_tip"></FormattedMessage>
      </div>
    </div>
  ) : null;
}
