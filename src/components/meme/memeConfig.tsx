    ...
    return {
      progress: {
        'lonk.fakes.testnet': {
          ...
          translateY: is_mobile ? '72px' : '110px',
          initW: is_mobile ? '0' : '0',
        ...
        'neko.fakes.testnet': {
          ...
          translateY: is_mobile ? '62px' : '100px',
        ...
        'blackdragon.fakes.testnet': {
          ...
          translateY: is_mobile ? '74px' : '110px',
          initW: is_mobile ? '6' : '6',
        ...
        'shitzu.fakes.testnet': {
          ...
          translateY: is_mobile ? '56px' : '90px',
    ...
    return {
      progress: {
        'lonk.fakes.testnet': {
          ...
          tail: LONK_CONFIG.tail,
          body: LONK_CONFIG.body,
          translateY: is_mobile ? '72px' : '88px',
          initW: is_mobile ? '0' : '0',
          feedIcon: LONK_CONFIG.feedIcon,
          stakeTip: 'LONK you welth!',
        },
        'neko.fakes.testnet': {
          ...
          tail: NEKO_CONFIG.tail,
          body: NEKO_CONFIG.body,
          translateY: is_mobile ? '62px' : '80px',
          initW: is_mobile ? '28' : '62',
          feedIcon: NEKO_CONFIG.feedIcon,
          stakeTip: 'Kung Hei Fat Choy!',
        },
        'blackdragon.fakes.testnet': {
          ...
          tail: DRAGON_CONFIG.tail,
          body: DRAGON_CONFIG.body,
          translateY: is_mobile ? '74px' : '88px',
          initW: is_mobile ? '6' : '6',
          feedIcon: DRAGON_CONFIG.feedIcon,
          stakeTip: (
            <div className="flex items-center gap-1">
        ...
        'shitzu.fakes.testnet': {
          ...
          tail: SHITZU_CONFIG.tail,
          body: SHITZU_CONFIG.body,
          translateY: is_mobile ? '56px' : '64px',
          initW: is_mobile ? '28' : '42',
          feedIcon: SHITZU_CONFIG.feedIcon,
          stakeTip: 'Woof-woof!',
        },
