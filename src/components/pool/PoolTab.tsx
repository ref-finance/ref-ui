...
export const PoolTab = () => {
  ...
  return (
    <div
      className="flex items-center justify-between rounded-2xl bg-cardBg text-primaryText font-normal mb-4 text-lg  p-1 xl:w-1/3 2xl:w-1/3 3xl:w-1/4 lg:w-1/2 md:w-5/6 mx-auto  xs:text-sm md:text-sm xs:w-auto xs:mx-2"
      style={{
        height: '50px',
      }}
    >
