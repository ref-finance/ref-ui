...
export const PoolTabV3 = ({ count }: { count?: number }) => {
  ...
  return (
    <div
      className={`flex items-center justify-between rounded-2xl bg-cardBg text-primaryText font-normal mb-7 text-lg  p-1 mx-auto lg:w-1/2 2xl:w-2/5 3xl:w-1/3  md:w-5/6 xs:w-auto xs:mx-2`}
      style={{
        height: '50px',
      }}
    >
