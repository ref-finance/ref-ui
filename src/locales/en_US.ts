...
const en_US = {
  ...
  v2_boost_tip:
    'DCL farms will support boosted farms. The Classic farms will run dry of rewards on the <span class="font-bold">1st of August 2022</span>.',
  v2_boost_tip2: 'DCL farms support boosted farms.',
  v2_boost_no_tip:
    'The Classic farms will run dry of rewards on the <span class="font-bold">1st of August 2022</span>.',
  no_farm_need_to_migrate: 'No Farm need to Migrate',
  v1_farms: 'Classic Farms',
  has_rewards_tip:
    'You have claimed rewards in <a class="text-greenColor text-base cursor-pointer underline hover:text-senderHot"  href="/farms" >Classic Farms</a>. You can withdraw them at any time.</div>',
  love: 'LOVE',
  Available_to_stake: 'Available to stake',
  you_staked: 'You staked',
  has_rewards_tip_in_v2:
    'Withdraw legacy rewards from <a href="/farms" class="text-sm text-greenColor cursor-pointer underline ml-1 hover:text-senderHot"> Classic Farms</a>.',
