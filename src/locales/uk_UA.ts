...
const uk_UA = {
  ...
  v1Legacy: 'Classic-Спадок',
  v2New: 'DCL-Новий',
  v2_new_farms: 'DCL Нові Ферми',
  // migrate_now: 'Розпочніть міграцію зараз ! ',
  migrate_now: 'міграцію зараз ! ',
  v2_boost_tip:
    'Ферми DCL підтримуватимуть посилені ферми. На фермах Classic закінчаться нагороди <span class="font-bold">1st. August, 2022.</span>',
  v2_boost_tip2: 'Ферми DCL підтримуватимуть посилені ферми.',
  v2_boost_no_tip:
    'На фермах Classic закінчаться нагороди <span class="font-bold">1st. August, 2022.</span>',
  no_farm_need_to_migrate: 'Немає ферм для переносу',
  v1_farms: 'Classic Ферми',
  has_rewards_tip:
    'Вам все ще потрібно отримати винагороди в  <a class="text-greenColor text-base cursor-pointer underline hover:text-senderHot"  href="/farms" >Classic Farms</a>. The rewards are not going anywhere, you can withdraw anytime.</div>',
  love: 'LOVE',
  Available_to_stake: 'Доступно для Стейкінгу',
  you_staked: 'Застейкано',
  has_rewards_tip_in_v2:
    'Legacy rewards to be withdraw in <a href="/farms" class="text-sm text-greenColor cursor-pointer underline ml-1 hover:text-senderHot"> Classic Farms</a>.',
