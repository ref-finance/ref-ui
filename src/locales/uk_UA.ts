const uk_UA = {  
  ...
  stake_your_liquidity_provider_LP_tokens:
    'Здійснюйте стейкінг своїх токенів постачальника ліквідності (LP)',
  ...
  registerToken:
    'Це реєструє новий токен на <br> біржі який ще на торгується',
  ...
  is_not_a_valid_swap_amount: 'недійсна сума свопу',
  not_nep_address:
  ...
  not_correct_address:
    'Введена адреса не вірна, будь ласка перевірте ще раз',
  ...
  my_watchlist: 'Мій список переглядів',
  h24_volume: 'об'єм за 24 години,
  hide_low_tvl_pools: 'Сховати низький TVL',
  watchlist_title: 'Мій список спостереження вгорі',
  add_watchlist: 'Додати список спостереження',
  remove_watchlist: 'Видалити список спостереження',
  my_watchlist_copy: 'Тут з’являться позначені пули',
  search_token: 'Пошук токена',
  language: 'Мова',
  deposit_to_add_liquidity: 'Внесіть депозит щоб додати ліквідність',
  ...
  reward_tokens: 'Токени винагороди',
  detail_tip: 'Деталі',
  ...
  auto_router_detail_sub_1: 'Цей маршрут оптимізує ваш обмін',
  auto_router_detail_sub_2: 'враховуючи всі пули для однієї пари.',
  auto_router_detail_sub_3: 'Детали:',
  introducing_parallel_swap: 'Представляємо Parallel Swap',
  at_least: 'Принамйні',
  xref_start_time: 'Початок о 01:00 UTC, 18 січня 2022 року.',
  xref_to_receive: 'отримати xREF',
  ref_to_receive: 'отримати REF ',
  more_expensive_than_best_rate_en: 'дорожче за найкращий тариф',
  ...
  go_to_your_account_to: 'Перейдіть до свого облікового запису для',
  deposit_l: 'Депозит',
  withdraw_l: 'Вивід',
  got_it: 'Зрозумів',
  ...
  from_terra: 'Terra',
  from_celo: 'Celo',
  no_result: 'На жаль, нам не вдалося знайти відповідну ферму',
  mulitple: 'Декілька',
