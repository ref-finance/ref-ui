...
const ru = {
  ...
  recent_one_mounth_activity: 'Заходи на один місяць',
  bonus_tip:
  ...
  applying_period: 'Період подачі заявки',
  community_gauge_share: 'Доля спільности',
  qualified_pools: 'Кваліфіковані пули',
