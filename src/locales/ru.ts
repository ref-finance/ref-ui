...
const ru = {
  ...
  // v1Legacy: 'Classic-Традиционные',
  // v2New: 'DCL-Новые',
  v1Legacy: 'Classic-Legacy',
  v2New: 'DCL-New',
  v2_new_farms: 'DCL Новые фермы',
  migrate_now: 'Выполнить миграцию!',
  v2_boost_tip:
    'DCL-фарминг будет работать для ферм с бустом. Classic-фарминг будет лишен наград после <span class="font-bold">1 августа 2022 года</span>',
  v2_boost_tip2: 'DCL-фарминг будет работа для ферм с бустом.',
  v2_boost_no_tip:
    'Classic-фарминг будет лишен наград после <span class="font-bold">1 августа 2022 года</span>',
  no_farm_need_to_migrate: 'Не требуется перенос фермы',
  v1_farms: 'Classic Фермы',
  has_rewards_tip:
    'У вас еще есть награды, которые вы должны вывести из <a class="text-greenColor text-base cursor-pointer underline hover:text-senderHot"  href="/farms" >Classic Ферм</a>. Эти награды никуда не денутся, вы можете снять их в любой момент.</div>',
  love: 'LOVE',
  Available_to_stake: 'Доступно для стейкинга',
  you_staked: 'Вы застейкали',
  has_rewards_tip_in_v2:
    'Ваши обычные награды, которые вы заберете из <a href="/farms" class="text-sm text-greenColor cursor-pointer underline ml-1 hover:text-senderHot"> Classic Ферм</a>.',
