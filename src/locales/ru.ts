...
const ru = {
  ...
  slippageCopy:
    'Проскальзывание означает разницу между тем, что <br> вы ожидаете получить, и тем, что вы фактически получаете из-за других действий',
  depositCopy:
  ...
  bridged_tokens: 'Перенесенные токены',
  gaming: 'Gaming',
  nft: 'NFT',
