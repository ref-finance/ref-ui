...
const es = {
  ...
  swap: 'Intercambio (Swap)',
  Swap: 'Intercambio (Swap)',
  exchange_tokens: ' Intercambio(Exchange) de Tokens',
  pool: 'Pool',
  Pool: 'Pool',
  pools: 'Pools',
  Pools: 'Pools',
  ...
  Create_New_Pool: 'Crear un nuevo Pool',
  your_liquidity: 'Tu Liquidez (Liquidity)',
  Your_Liquidity: 'Tu Liquidez (Liquidity)',
  farms: 'Farms',
  Farms: 'Farms',
  airdrop: 'Airdrop',
  ...
  swap_rate: 'Tasa de intercambio (Swap rate)',
  ...
  number_of_unique_stakers: 'Número de participantes únicos (en Stak',
