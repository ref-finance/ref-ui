...
const es = {
  ...
  v2New: 'DCL-New',
  v2_new_farms: 'DCL New Farms',
  migrate_now: 'Migrar ahora!',
  v2_boost_tip:
    'Las farms DCL admitirán boosted farms. Las farms Classic se quedarán sin recompensas el <span class="font-bold">1 de agosto de 2022</span>.',
  v2_boost_tip2: 'Las DCL farms soportan las  boosted farms.',
  v2_boost_no_tip:
    'Las farms Classic se quedarán sin recompensas el <span class="font-bold">1 de agosto de 2022</span>..',
  no_farm_need_to_migrate: 'Ninguna farms necesita migrar',
  v1_farms: 'Classic Farms',
  has_rewards_tip:
    'Has reclamado recompensas en <a class="text-green Color text-based cursor-pointer underline hover:text-sender Hot" href="/farms" >Classic Farms</a>. Puede retirarlos en cualquier momento.</div>',
  love: 'LOVE',
  Available_to_stake: 'Disponibe para hacer stake',
  you_staked: 'Ha hecho un stake',
  has_rewards_tip_in_v2:
    'Retire las recompensas heredadas de <a href="/farms" class="text-sm text-greenColor cursor-pointer underline ml-1 hover:text-senderHot"> Classic Farms</a>.',
