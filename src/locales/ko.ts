...
const ko = {
  ...
  you_shares: '당신의 지분',
  lock_your_lp_tokens_with_booster: '당신의 LP 토큰을 잠가서(lock) 보상을 더 받으세요.',
  ...
  slash_tip: '엑싯 수수료 = 엑싯 수수료 요금rate * 잠금 종료까지의 기간* 잠금 수량',
  nonBoosted: '부스트 없음',
  ...
  unclaimed_earnings_tip:
    '미수령된 수입(DCL 풀과 농장 보상)의 USD 기준 가격.',
  ...
  overview: '전체 둘러보기',
  positions_2: '포지션', 
  'deposit_near_tip_0.5': '예치하기 위해서는 가스 비용 처리를 위해 최소 0.5NEAR를 지갑에 남겨 두세요.',
  trade: '거래', 
  earn_2: '얻다', 
  portfolio: '포트폴리오',
  more_2: '더 보기', 
  ...
  position_has_staked_tip: '이 포지션은 다른 농장이 이미 스테이킹 하고 있습니다.',
  ...
  ledger_guide_tip_1:
    'Ledger 지갑을 트랜잭션에 성공적으로 사용하기 위해,',
  ...
  exceed_rate_limit:
    '요율rate 한계를 넘었습니다. 60초 후에 시도해주세요',
