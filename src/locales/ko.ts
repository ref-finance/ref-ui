...
const ko = {
  ...
  v1Legacy: 'Classic-구버전',
  v2New: 'DCL-신버전',
  v2_new_farms: 'DCL 신버전 농장',
  migrate_now: '지금 이주하세요!',
  v2_boost_tip:
    'DCL 농장에선 부스팅이 가능합니다. Classic 농장들은 다음 날자 이후로 보상을 지급하지 않습니다: <span class="font-bold">2022년 8월 1일</span> ',
  v2_boost_tip2: 'DCL 농장에선 부스팅이 가능합니다.',
  v2_boost_no_tip:
    'Classic 농장들은 다음 날자 이후로 보상을 지급하지 않습니다: <span class="font-bold">2022년 8월 1일</span> ',
  no_farm_need_to_migrate: '이주해야하는 농장은 없습니다.',
  v1_farms: 'Classic 농장',
  has_rewards_tip:
    '출금할 리워드가 다음 농장들에 남아있습니다: <a class="text-greenColor text-base cursor-pointer underline hover:text-senderHot"  href="/farms" >Classic Farms</a>. 보상이 사라지진 않습니다. 언제든 출금할 수 있습니다.</div>',
  love: 'LOVE',
  Available_to_stake: '스테이킹 가능한 양은:',
  you_staked: '당신이 스테이킹한 양은:',
  has_rewards_tip_in_v2:
    '출금가능한 레거시 보상들이 기다립니다 <a href="/farms" class="text-sm text-greenColor cursor-pointer underline ml-1 hover:text-senderHot"> Classic Farms</a>.',
  how_to_get: '어떻게 받나요?',
  get_booster: '부스터 받기',
