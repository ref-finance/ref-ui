const ko_in_risks_page = {
  ...
  crypto_trading_addiction_paragraph_1:
    '암호화폐 거래는 매우 중독성이 높습니다. 여러 #전문가#들에 따르면 이는 도박 중독의 한 형태일 수 있습니다. 도박 중독은 인생을 망칠 수 있습니다.  ',
  ...
  Locked_paragraph_3: '#1. deploy-code action이 있는 트랜잭션이 있을 경우#',
  Locked_paragraph_4:
    '2. 계약 내에 deploy-code action을 발동시키는 트리거가 내장되어 있는 경우',
  Locked_paragraph_5:
    '이 코드를 트랜잭션을 통해 재배포하려면, 그 트랜잭션은 #full-access key#로 서명되어야 합니다. 만약 계약 내에 그런 키가 아예 없고, #unless there is a dedicated support in the contract code itself#하다면, 이 코드는 재배포가 불가능합니다. 이 때 우리는 이 계약을 "잠김" 표시합니다 ',
  Locked_paragraph_6:
    '만약 하나라도 #full-access key#가 #계약 계정#에 등록되어 있는 경우, 그 계약은 잠기지 않습니다. ',
...
const ko = {
  ...
  slippageCopyForMobile:
    '슬리피지(미끄러짐)란 당신이 처음에 기대한 수익과, #다른 사람이 우선 실행되는 바람에 달라져버린 실제 수익의 차이#를 말합니다. ',
  slippageCopy:
  ...
  no_pool_eng_for_chinese: ' #this was empty when i found it',
  ...
  remove_tip: '#share#로 유동성을 제거하면 수수료가 들지 않습니다',
  ...
  all: '전부',
  all_5: '한번에 최대 5토큰씩만',
  insufficient_shares: '#shares#가 불충분함',
  shares_removed: '#Shares#',
  shares_avaliable: '가능한 #Shares#',
  minimum_shares: '최소 shares',
  shares_tip: '가능한 #Shares# / 당신이 소유한 #shares# 전체',
  ...
  xref_title1: '더 많은 수익',
  xref_title2: '#REF로 xREF#에 스테이킹하기',
  xref_introdution:
  ...
  input_greater_than_available_shares: '가능한 #share#보다 입력이 큽니다.',
  ...
  support_ledger_tip:
    "레져는 메모리가 제한되는 구조 탓에<br /> 거대한 트랜잭션 양을 감당할 수 없습니다. <br /> (예: 오토 라우터 - 여러 풀에서 한번에 거래)<br /> 활성화시, '보조 장부' 옵션은 <br /> 가장 간단한 형상으로 트랜잭션을 제한해서 <br />합리적인 크기의 트랜잭션이 서명 될 수 있게 합니다. <br />(#오토 라우터에서 찾은 <br /> 최적의 값보다 약간 손해를 <br /> 볼 수 있습니다#) ",
  start: '시작',
