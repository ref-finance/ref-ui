...
const vi = {
  ...
  v2New: 'DCL-New',
  v2_new_farms: 'DCL Farms mới',
  migrate_now: 'Migrate ngay bây giờ!',
  v2_boost_tip:
    'DCL farms sẽ hỗ trợ boosted farms. Classic farms sẽ chạy phần thưởng <span class="font-bold">1st. Tháng 8, 2022.</span>',
  v2_boost_tip2: 'DCL farms sẽ hỗ trợ boosted farms.',
  v2_boost_no_tip:
    'Classic farms sẽ chạy phần thưởng <span class="font-bold">1st. Tháng 8, 2022.</span>',
  no_farm_need_to_migrate: 'Không có farm nào cần Migrate',
  v1_farms: 'Classic Farms',
  has_rewards_tip:
    'Bạn vẫn có phần thưởng đã nhận để rút trong <a class="text-greenColor text-base cursor-pointer underline hover:text-senderHot"  href="/farms" >Classic Farms</a>. Phần thuowgnr của bạn sẽ không biến mất, bạn có thể rút bất kì lúc nào.</div>',
  love: 'LOVE',
  Available_to_stake: 'Stake khả dụng',
  you_staked: 'Bạn đã stake',
  has_rewards_tip_in_v2:
    'Tải sản là phần thưởng sẽ được rút trong <a href="/farms" class="text-sm text-greenColor cursor-pointer underline ml-1 hover:text-senderHot"> Classic Farms</a>.',
