...
const vi = {
  ...
  admin_sentence_1:
    'Ref Finance được quản lí bởi  <a rel="noopener noreferrer nofollow" target="_blank" class="underline cursor-pointer text-riskTextColor hover:text-white" href="https://app.astrodao.com/dao/ref-finance.sputnik-dao.near">Ref Finance Sputnik DAO</a> và dần dần sẽ chuyển đổi thành một DAO phi tập chung toàn phần.',
  admin_sentence_2:
