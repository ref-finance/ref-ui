...
const zh_CN = {
  ...
  v1Legacy: '经典-Legacy',
  v2New: 'DCL-New',
  v2_new_farms: 'DCL 新版农场',
  migrate_now: '现在升级!',
  v2_boost_tip:
    'DCL农场将支持加速农场。经典农场将在<span class="font-bold">2022年8月1日</span>耗尽奖励。',
  v2_boost_tip2: 'DCL农场支持加速农场。',
  v2_boost_no_tip:
    '经典农场将在<span class="font-bold">2022年8月1日</span>耗尽奖励。',
  no_farm_need_to_migrate: '没有需要升级的农场',
  v1_farms: '经典 农场',
  has_rewards_tip:
    '在<a class="text-greenColor text-base cursor-pointer underline hover:text-senderHot"  href="/farms" >经典农场</a>中您还有未提取的奖励。奖励不会去任何地方，您可以随时提取。</div>',
  love: 'LOVE',
  Available_to_stake: '可供质押',
  you_staked: '你已质押',
  has_rewards_tip_in_v2:
    '从<a href="/farms" class="text-sm text-greenColor cursor-pointer underline hover:text-senderHot mr-1"> 经典 农场</a>中提取遗留奖励。',
  how_to_get: '如何获取?',
  get_booster: '获得加速器',
  ended_farms: '已结束农场',
