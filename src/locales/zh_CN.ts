...
const zh_CN = {
  ...
  booster_change_reason: '助推器将因追加时间而改变',
  initial_booster: '初始助推器',
  append_timing: '追加时间',
  ...
  has_rewards_tip_in_v2:
    '<a href="/farms" class="text-sm text-greenColor cursor-pointer underline hover:text-senderHot mr-1"> V1 Farms</a>中有未提取的奖励。',
  how_to_get: '如何获取?',
  get_booster: '获得助推器',
  ended_farms: '已结束农场',
  boosted_farms: '被助推的农场',
  your_farm: '你的农场',
