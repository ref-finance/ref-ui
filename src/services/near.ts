...
export const TRUNEAR_NEAR_TOKEN_IDS = config.TRUNEAR_NEAR_TOKEN_IDS;
...
export const TRUNEAR_NEAR_POOL_IDS = config.TRUNEAR_NEAR_POOL_ID;
...
export const getStableTokenIndex = (stable_pool_id: string | number) => {
  ...
  switch (id) {
    ...
    case TRUNEAR_NEAR_POOL_ID.toString():
      return TRUNEAR_NEAR_POOL_INDEX;
  }
};
