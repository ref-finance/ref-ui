      ...
      <div className={`bottom-ga ${showBottomGA ? '_show' : ''}`}>
        <div className={'sm:flex justify-between gap-6'}>
          ...
          >
            ...
            <span className='underline cursor-pointer font-bold font-gothamBold' onClick={handleModalOpen}>
              Privacy Policy.
            </span>
          </div>
  ...
  return (
    <div className='text-primaryText ga-content'>
      ...
      <p>
        ...
        business units and affiliates, as well as their respective
        representatives and/or agents (collectively referred to herein as
        "we", "our", or "us") regarding the collection, use, disclosure and
        sharing of personal information when you visit our website
        https://www.ref.finance/ (the "Website"). We recognise our
        responsibilities in relation to the collection, holding, processing,
        use and/or transfer of personal data. Your privacy is of utmost
        importance to us. By using our website, you agree to the terms
        outlined in this policy. This Privacy Policy supplements but does not
        supersede nor replace any other consent which you may have previously
        provided to us nor does it affect any rights that we may have at law
        in connection with the collection, use and/or disclosure of your
        personal data. We may from time to time update this Privacy Policy to
        ensure that this Privacy Policy is consistent with our future
        ...
        updated, we will post a notice on the Website and also change the
        "Last Updated" date indicated at the top. For the avoidance of doubt,
        this Privacy Policy forms part of the terms and conditions governing
        your relationship with us and should be read in conjunction with such
      ...
      <p>
        This Privacy Policy describes how we may collect, use, disclose,
        process and manage your personal data, and applies to any individual’s
        personal data which is in our possession or under our control.
      </p>
      <h2>Personal data</h2>
      <p>
      ...
      <div>
        (c) information about your use of our services and Website, and
        specific user interactions with the Website such as features utilised,
        areas visited or clicked on, and time spent; and
      </div>
      <div>
      ...
      <p>
        ...
        our services, access the Website, interact with other users of our
        services, sign up for any beta/testing services, open an email from us
        or fill in any form or survey, register a user account or update a
        user account that you registered with us, engage with us (whether
        through live chat, message, phone call, email, social media accounts,
        messaging platforms, attendance at in-person events, opting-in to
        receive our marketing messages, or subscribing to our mailing lists),
      ...
      <p>
        ...
        there is no centralised place where it is located either. Accordingly,
        by design, a blockchain’s data cannot be changed or deleted and is
        said to be "immutable". This may affect your ability to exercise your
        rights such as your right to erasure ("right to be forgotten"), or
        your rights to object or restrict processing of your personal data.
        Data on the blockchain cannot be erased and cannot be changed.
        Although smart contracts may be used to revoke certain access rights,
        and some content may be made invisible to others, it is not deleted.
      </p>
      <p>
        ...
        your wallet’s private key. The ultimate decisions to (a) transact on
        the blockchain using your wallet address, as well as (b) share the
        public key relating to your wallet address with anyone (including us)
        rests with you. IF YOU WANT TO ENSURE YOUR PRIVACY RIGHTS ARE NOT
        AFFECTED IN ANY WAY, YOU SHOULD NOT TRANSACT ON BLOCKCHAINS AS CERTAIN
        RIGHTS MAY NOT BE FULLY AVAILABLE OR EXERCISABLE BY YOU OR US DUE TO
        THE TECHNOLOGICAL INFRASTRUCTURE OF THE BLOCKCHAIN. IN PARTICULAR THE
      ...
      to "add" their digital wallet address to access our services, as well as
      the ability to "remove" such stored wallets. All data obtained by us in
      connection with your digital wallet addresses shall be treated as
      ...
      <div>
        (e) recording and/or encryption on any blockchain, network or
        platform;
      </div>
      <div>
      ...
      <div>
        (k) complying with all applicable laws, regulations, rules,
        directives, orders, instructions and requests from any local or
        foreign authorities, including regulatory, governmental, tax and law
        enforcement authorities or other authorities;
      </div>
      <div>
        (l) enforcing obligations owed to us, protecting our rights or
        property, and protecting against legal liability; and/or
      </div>
      <div>
        (m) seeking professional advice, including legal or tax advice.
      </div>
      ...
      calls, facsimile and other mobile messaging services, and may be sent
      directly by us or by various third parties which we work with. In doing
      so, the sender will comply with all applicable data protection and
      privacy laws. In respect of sending telemarketing messages to your
      telephone number via short message service, telephone calls, facsimile
      and other mobile messaging services, please be assured that we shall
      only do so if we have your clear and unambiguous consent in writing or
      other recorded form to do so or if you have not otherwise made the
      appropriate registration of that number with the Do Not Call Registry.
      If we have an ongoing relationship with you and you have not indicated
      to us that you do not wish to receive telemarketing messages sent to
      your telephone number, we may send you telemarketing messages to that
      number related to the subject of our ongoing relationship via short
      message service, facsimile and other mobile messaging services (other
      than a voice or video call). You may at any time request that we stop
      contacting you for marketing purposes via selected or all modes. To find
      out more on how you can change the way we use your personal data for
      marketing purposes, please contact us. Nothing in this Privacy Policy
      shall vary or supersede the terms and conditions that govern our
      ...
      your use of the website (including your IP address) is transmitted to
      ...
      website activity for website operators, and provide other services
      related to website activity and internet usage. Google may also transfer
      this information to third parties if required by law or where third
      ...
      our website, you consent to the processing of data about you by Google
      ...
      external data, as well as Security Cookies for security purposes. You
      may set up your web browser to block cookies from monitoring your
      ...
      kept confidential and secure. For more information about the third
      parties with whom we share your personal data, you may, where
      appropriate, wish to refer to the agreement(s) and/or terms and
      conditions that govern our relationship with you or our customer. You
      may also contact us for more information contact us at the contact
      details provided below. You are responsible for ensuring that the
      personal data you provide to us is accurate, complete, and not
      misleading and that such personal data is kept up to date. You
      acknowledge that failure on your part to do so may result in our
      inability to provide you with the products and services you have
      requested. To update your personal data, please contact us at the
      contact details provided below. Where you provide us with personal data
      concerning individuals other than yourself, you are responsible for
      obtaining all legally required consents from the concerned individuals
      and you shall retain proof of such consent(s), such proof to be provided
      to us upon our request. We may transfer, store, process and/or deal with
      your personal data in any jurisdiction, and accordingly such personal
      data may be transferred to computers, servers or hardware located
      ...
      (including without limitation the Standard Contractual Clauses approved
      by the European Commission). Your consent to this Privacy Policy
      followed by your submission of such information represents your
      agreement to the transfer of personal data as described herein.
      ...
      concerns that may arise. We may need to retain information for a longer
      period where we need the information to comply with regulatory or legal
      requirements or where we may need it for our legitimate purposes (e.g.
      to help us respond to queries or complaints, fighting fraud and
      financial crime, responding to requests from regulators etc). When we no
      longer need to use personal data, we will remove it from our systems and
      records and/or take steps to anonymise it so that you can no longer be
      identified from it.
      ...
      of Google Analytics tracking by using the Google Analytics Opt-Out
      Browser Add-on.
      <h2>Security</h2>
      We take reasonable measures to protect the information collected through
      our website. However, no data transmission over the internet or
