  ...
  chains: [
    {
      id: '0x1',
      token: 'ETH',
      label: `Ethereum ${ETH_NETWORK}`,
      rpcUrl: `https://${ETH_NETWORK}.infura.io/v3/${INFURA_KEY}`,
    },
    {
      id: '0x2105',
      token: 'ETH',
      label: 'Base',
      rpcUrl: `https://${ETH_NETWORK}.base.org`,
    },
  ],
};
...
export const TokenList: BridgeModel.BridgeTokenMeta[] = [
...

  {
    ...
    decimals: 6,
    addresses: {
      ETH: IS_MAINNET ? '0xdAC17F958D2ee523a2206206994597C13D831ec7' : '',
      NEAR: IS_MAINNET
  ...
  },
  {
    ...
    decimals: 6,
    addresses: {
      ETH: IS_MAINNET ? '0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48' : '',
      NEAR: IS_MAINNET
  ...
  },
  {
    ...
    decimals: 18,
    addresses: {
      ETH: IS_MAINNET ? '0x6B175474E89094C44Da98b954EedeAC495271d0F' : '',
      NEAR: IS_MAINNET
  ...
  },
  {
    ...
    decimals: 8,
    addresses: {
      ETH: IS_MAINNET ? '0x2260FAC5E5542a773Aa44fBCfeDf7C193bc2C599' : '',
      NEAR: IS_MAINNET
  ...
  },
  {
    ...
    decimals: 18,
    addresses: {
      ETH: IS_MAINNET ? '0xf5cfbc74057c610c8ef151a439252680ac68c6dc' : '',
      NEAR: IS_MAINNET
  ...
  },
  {
    ...
    decimals: 18,
    addresses: {
      ETH: IS_MAINNET ? '0x4691937a7508860f876c9c0a2a617e7d9e945d4b' : '',
      NEAR: IS_MAINNET
