  ...
  return (
    ...
    >
      <FormattedMessage
        ...
        id="perpTipDown"
        defaultMessage={
          'Order book system update will be conducted from 2024/05/28 07:00 AM to 2024/05/28 08:30 AM (UTC), during which time Spot and Perps will be temporarily unavailable.'
        }
        values={{
          perpTipLink: (
            <a
