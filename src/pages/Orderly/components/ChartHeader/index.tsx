  ...
  return (
    <div className='absolute left-0 top-8 pt-4 z-50'>
      ...
      >
        ...
        <div
          className='border border-borderC flex items-center justify-between bg-black bg-opacity-20 w-full rounded-lg px-2 py-1'>
          <input
            type='text'
...
function ChartHeader(props?: any) {
  ...
  return (
    ...
    >
      <div
        className='rounded-xl xs:rounded-lg frcs mr-2 xs:mr-0.5 xs:text-xs gap-1 text-13px border border-v3SwapGray p-1 border-opacity-20  xs:p-0.5 '>
        {['spot', 'perps'].map((type) => {
          return (
            <div
