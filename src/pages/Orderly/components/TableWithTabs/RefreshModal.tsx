          ...
          <div className="flex items-center mb-5 justify-center">
            <span className="text-base text-white text-center">
              {intl.formatMessage({
                ...
                defaultMessage:
                  'Please refresh the data to continue',
              })}
            </span>
          </div>
