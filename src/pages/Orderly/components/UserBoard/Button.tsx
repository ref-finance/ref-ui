...
function BuyRec({ select }: { select: boolean }) {
  if (select) {
    return (
      <svg width='144' height='40' viewBox='0 0 144 40' fill='none' xmlns='http://www.w3.org/2000/svg'>
        ...
        />
        <defs>
          <linearGradient id='paint0_linear_96_3428' x1='72.8125' y1='0' x2='72.8125' y2='40' gradientUnits='userSpaceOnUse'>
  ...
  return (
    <svg width='144' height='40' viewBox='0 0 144 40' className='-z-10' fill='none' xmlns='http://www.w3.org/2000/svg'>
      <path
        d='M0 7.99999C0 3.58172 3.58172 0 8 0H139.462C142.359 0 144.295 2.98332 143.115 5.62894L128.847 37.6289C128.204 39.0711 126.773 40 125.194 40H8C3.58173 40 0 36.4183 0 32V7.99999Z'
        fill='#344B5C'
      />
  ...
  if (select) {
    return (
      <svg width='144' height='40' viewBox='0 0 144 40' fill='none' xmlns='http://www.w3.org/2000/svg'>
        ...
        />
        <defs>
          <linearGradient id='paint0_linear_96_3774' x1='71.1875' y1='40' x2='71.1875' y2='2.28882e-05' gradientUnits='userSpaceOnUse'>
...
function BuyButton(props: { select: boolean; onClick: () => void }) {
  ...
  return (
    <div className='relative  w-1/2  flex items-center justify-center' {...props}>
      <div className='absolute cursor-pointer z-10'>
        <BuyRec select={select}></BuyRec>
      </div>
      <span className={`${select ? 'text-white' : 'text-boxBorder'}  cursor-pointer text-base z-20 relative font-bold`}>Buy</span>
    </div>
  );
}
...
function SellButton(props: { select: boolean; onClick: () => void }) {
  ...
  return (
    <div className='relative  w-1/2  flex items-center justify-center' {...props}>
      ...
      <span className={`${select ? 'text-white' : 'text-boxBorder'} cursor-pointer  z-20 text-base relative  font-bold`}>Sell</span>
    </div>
  );
}
